...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1519: () => globalThis.window,
      _1524: (x0,x1) => x0.height = x1,
      _1526: (x0,x1) => x0.width = x1,
      _1529: x0 => x0.head,
      _1530: x0 => x0.classList,
      _1534: (x0,x1) => x0.innerText = x1,
      _1535: x0 => x0.style,
      _1537: x0 => x0.sheet,
      _1548: x0 => x0.offsetX,
      _1549: x0 => x0.offsetY,
      ...
      _3454: x0 => x0.navigator,
      _3843: x0 => x0.userAgent,
...
"What is Git",
"subtitle",
"Version Control: Track, Team, Protect",
"/courses/git",
"Git Basics",
"Commit, Branch, Code Safe",
"/courses/git/basics",
...
"Git Best Practices",
"Git and GitHub",
"Control Code, Team Up",
"/courses/git/git-and-github",
"What is GitHub?",
"Link Git & GitHub",
"Clone Remote Repos",
"Push & Pull Basics",
...
"Git Contribute",
"Fork, Share, Open Source",
"/courses/git/contribute",
"Contribution Basics",
"Fork a Repository",
"Clone Your Fork",
"Branch for Changes",
...
"Git Advanced",
"Rebase, Hook, Automate",
"/courses/git/advanced",
"Rebasing vs. Merging",
"Interactive Rebase",
"Advanced Stashing",
...
"Git Exercises",
"Practice, Test, Master Skills",
"/courses/git/exercises",
...
"> git config --global hook.preventwip true",
...
"> git commit -m \"Oops\" && git revert HEAD",
...
"Fork the repo.",
"Clone your fork and sync with upstream.",
"Fix the typo in a branch fix/typo.",
...
"Test if the script works at each step.",
"Identify the bad commit and revert it.",
"> git bisect start\n> git bisect good a1b2c3d\n> git bisect bad HEAD\n> ./test-payment-script.sh  # Simulate testing\n> git bisect reset\n> git revert <bad-commit>",
"You accidentally:",
"Added \"passwords.txt\" (untracked)",
"Committed a buggy \"login.js\"",
"Force-pushed broken code to \"main\"",
...
"Analogy:\n",
"Use git status first to confirm what’s unstaged.",
"Pro Tip:\n",
...
"Stage a file, then unstage it without losing changes.",
"Exercise:\n",
...
"Commands: ",
"Redo a commit with extra changes.",
"Soft: ",
...
"Use Case: ",
"Resolve conflicts during revert like a merge.",
"Pro Tip: ",
...
"Steps:",
"Intentionally reset a commit, then recover it.",
"Delete Digital Clutter",
"> git clean -df  # Remove untracked files/directories",
"Run \"git clean -n\" first for a dry run!",
"Safety First:\n",
"Recover from a Botched History Rewrite",
"git reflog",
"Find the pre-rebase state in ",
"Reset:",
...
"Never force-push to shared branches (disrupts teamwork).",
"Nuclear Warning:\n",
"Surgically Remove Bad Commits",
"Workflow:",
"> git rebase -i HEAD~5  # Drop or edit commits",
"Remove a secret leaked in an old commit.",
"Use Case:\n",
"Handle Cryptographic Signatures",
" (invalidates GPG signature).",
"Never amend/rebase signed commits",
" \"git revert\" to undo them publicly.",
"Only use",
"Rule:",
"Undo Like a Pro",
"Prefer revert over reset.",
"Public History: ",
"Warn collaborators before force-pushing.",
"Teamwork: ",
...
"Solo work, clean history.",
"Rebase: ",
"Teamwork, audit trails.",
"Merge: ",
...
"Switch branches mid-task without messy commits.",
...
"Dependencies (like Git repos).",
"Submodules: ",
"Embedded code (no extra .git).",
"Subtrees: ",
"Key Difference:",
"Automate Workflows",
"Example (Prevent bad commits):",
"# .git/hooks/pre-commit  \n> if grep -q \"TODO\" code.js; then  \n  echo \"Commit blocked: Remove TODOs!\"  \n  exit 1  \nfi  ",
"Enforce tests, linting, or commit messages.",
"Use Cases: ",
"Git’s Safety Net",
...
"Find which commit broke the login button.",
"Exercise: ",
...
"Prevent tampering (required for Linux kernel).",
...
"Generate a patch and email it.",
"The Open-Source Playground",
"Fix bugs, add features, learn collaboratively.",
"Why Contribute?\n",
"Fork → Clone → Branch → Code → PR → Iterate.",
"Workflow: ",
...
"Downloads the repo, including all history and branches.",
"Clone: ",
"Your fork is origin, the original repo is upstream.",
"Remote: ",
...
"Use keywords like \"Closes #10\" to auto-link issues.",
...
"Never force-push after reviews (breaks comment threads).",
"Golden Rule:\n",
...
"Key Difference: ",
"Plan and Track Work",
"Describe bugs, request features.",
"Create: ",
"Standardize with \".github/ISSUE_TEMPLATE.md\".",
"Templates: ",
"Issues:",
"Forums for Q&A, brainstorming (enable in repo settings).",
"Discussions:\n",
"Use \"@mention\" to tag maintainers or link contributors.",
"Certify Your Work",
...
"Share your merged PR on LinkedIn!",
...
"Link PRs to Issues (e.g., \"Closes #123\").",
"https://www.conventionalcommits.org/",
"Conventional Commits",
"Use ",
" for clarity.",
"Join Open-Source Communities",
"Click \"Fork\" on any GitHub repo.",
...
"Link PRs to auto-close issues: \"Fixes #45\".",
"Automation: ",
...
"Run tests, deploy sites, send notifications.",
...
"Code Like a Pro",
"Explain your project, add badges.",
"README.md: ",
"MIT, GPL, or Apache.",
"LICENSE: ",
"Exclude secrets, binaries.",
".gitignore: ",
...
"Why It Matters:",
"Local (solo) vs. Distributed (team) – Git is the latter.",
"Types: ",
...
"VohuCode Github",
"Need help with lessons?",
"Suggest a project tutorial?",
"Guest on our tech podcast?",
"Shape vohucode’s future",
"Feedback? ",
"Build something epic together",
"Collaborate? ",
"Why Reach Out?",
"At vohucode:",
"We’re redefining how programming is taught.",
"\nPowered by AI mentors and grounded in real-world projects",
"Learn smarter ",
"with adaptive lessons tailored to your pace",
"Code confidently ",
"through hands-on app-building challenges",
"Stay ahead ",
"with weekly tech podcasts and industry insights",
"Whether you’re stuck on a lesson, want to collaborate, or just have feedback – we’re here to help.",
"noRepeat",
"ImageRepeat.",
...
"_scrollAwareContext",
"_invertColors",
"https://github.com/vohucode",
" Powered by AI mentors and grounded in real-world projects",
"we’re redefining how programming is taught.",
"Share your coding journey?",
"*Drop us a message below We reply faster than a Python script!*",
"What is Python?\nYour Friendly Guide to the World of Coding",
"No tech jargon. No overwhelm. Just a fun, easy intro to Python—and how it can open doors you never imagined.",
"Welcome to Python!",
"Let’s be honest: learning to code can feel intimidating. Words like “algorithms” and “debugging” sound like they belong in a sci-fi movie. But what if coding could be as simple as writing a recipe or giving your computer a to-do list?\n\nThat’s Python.\n\nPython isn’t just a programming language—it’s a superpower for solving real-world problems. Whether you want to automate boring tasks, build a website, analyze data, or even create AI, Python is your best friend. And the best part? You don’t need any experience to start.",
"It Reads Like English!\nPython code is designed to be simple. For example:",
"> print(\"Hello, future coder! 👋\")",
"From Netflix’s recommendation engine to Instagram’s backend, Python powers the apps you use daily. Even NASA uses it!",
"It’s Everywhere\n",
"Automate sending birthday emails.",
"Scrape websites for the latest memes.",
"Create a chatbot that answers questions.",
"You Can Build Cool Stuff Fast",
"Stuck? Millions of Python learners and developers are online to help. No judgment, just answers.",
"The Community is Your Cheer Squad\n",
"Why Python is Perfect for Beginners?",
"Python isn’t just a “practice” language—it’s used by companies you know and love",
"Recommends songs you’ll actually like using Python’s data analysis tools.",
"Spotify\n",
"Uses Python to personalize your binge-watching list.",
"Netflix\n",
"Analyzes space mission data and controls Mars rovers.",
"NASA\n",
"Handles millions of posts and likes every second.",
"Instagram\n",
"Trains self-driving car algorithms with Python’s machine learning libraries.",
"Tesla\n",
"Hospitals use Python to predict disease outbreaks.",
"Farmers analyze crop data to grow healthier plants.",
"Artists generate digital masterpieces with code.",
"Even outside tech:",
"Python in the Real World\nFrom Self-Driving Cars to Spotify Playlists",
"Python’s power comes from its simplicity. Here’s how it works:",
"Analyze spreadsheets like a pro.",
"Pandas: ",
"Build websites faster than ordering pizza.",
"Django: ",
"Create AI that recognizes your face.",
"TensorFlow: ",
"Example\nSorting a playlist by song length takes 3 lines of code:",
"playlist = [{\"song\": \"Dancing Queen\", \"length\": 3.5}, {\"song\": \"Bohemian Rhapsody\", \"length\": 5.9}]\nsorted_playlist = sorted(playlist, key=lambda x: x[\"length\"])\nprint(sorted_playlist)  ",
"Libraries for Everything",
"Rename 1,000 files with one click.",
"Scrape website data without copying/pasting.",
"Send 100 personalized emails automatically.",
"Automate the Boring Stuff\nPython can handle repetitive tasks in seconds:",
"Python’s Secret Sauce: Simple but Mighty",
"Chatbots like ChatGPT.",
"Fraud detection systems for banks.",
"Medical tools that diagnose diseases.",
"AI & Machine Learning\nPython is the #1 language for AI. Companies pay top dollar for Python developers to build:",
"Predict stock market trends.",
"Track climate change patterns.",
"Analyze TikTok virality.",
"Data Science\nPython turns data into decisions. For example:",
"Build the next Instagram or Pinterest with frameworks like Django or Flask.",
"Web Development\n",
"Python scripts can detect hacking attempts and protect sensitive data.",
"Cybersecurity\n",
"Program smart homes, drones, or even coffee machines!",
"Robotics & IoT\n",
"Python’s Future: Your Ticket to Tomorrow’s Jobs\nLearning Python isn’t just about coding—it’s about future-proofing your career. Here’s why:",
"Python developers earn $100,000+ on average (Glassdoor).",
"Python skills are required for 75% of tech job postings (LinkedIn).",
"Job Market Snapshot:",
"How to Start Learning Python?",
"Coding is like cooking: you’ll burn a few eggs before you make a perfect omelet. Mistakes are part of the journey!",
"Forget Perfection\n",
"Write a program that jokes with you.",
"Calculate your monthly coffee budget.",
"Learn by Doing\nDon’t memorize textbooks. Start small:",
"Modern code learning platforms (like ours!) give you instant feedback, so you’re never stuck staring at a confusing error.",
"Use Tools That Help, Not Hurt\n",
"Let’s write a tiny program together. Imagine you’re teaching your computer to roast your friends:",
"Python code:",
"friend = \"Alex\"\nprint(f\"{friend}, your coding skills are 🔥 (literally).\")  ",
"Alex, your coding skills are 🔥 (literally).",
"A Taste of Python",
"Ready to Unlock Your Python Superpower?",
"If you’re thinking, “Okay, this sounds cool, but where do I start?”—we’ve got you.",
"https://vohucode.pages.dev/courses/python",
"Python for Absolute Beginners",
"Join our ",
"course and:",
"Code real projects from Day 1 (no boring theory).",
"Learn by building\n",
"Our AI catches errors and explains fixes in plain English.",
"AI mentor\n",
"We use real world based challenges to teach you code!",
"Work on real world projects\n",
"Python isn’t just a skill—it’s a way to turn “I can’t” into “I coded this!” Whether you want to boost your career, automate life’s chores, or just try something new, Python is the perfect first step.",
"Your keyboard’s waiting. Let’s code something awesome. 🚀",
"/courses/python",
...
"Small, frequent commits > giant dumps.",
"Commit Often:\n",
"Avoid “fixed stuff” – be specific.",
"Write Useful Messages:\n",
"Use names like \"feat/login\" or \"fix/typo\".",
"Branch Strategically:\n",
"on shared branches.",
"Never Force Push ",
"GitHub adds superpowers to Git:",
...
"Free $1000s in tools for learners:",
...
"assets/images/Git and GitHub 101.png",
"Git 101",
"The Ultimate Starter Guide for Future Developers",
"assets/images/Python_Blog_Introduction.png",
"What is Python?",
"Discover why Python is easy to learn, wildly popular, and used in everything from apps to AI.",
"Code Odyssey: Skill Paths",
"AI-Mentored Paths to Global Code",
"assets/images/Git_Learning_Session.png",
"Git and Github Tutorial",
"Learn by doing. No lectures. Build projects employers love",
"assets/images/Python_Learning_Session.png",
"Python Tutorial",
"Learn → Build → Lead: AI-Mentored Paths to Global Tech Mastery",
...
"❤️ Best Supports In Your Learning",
"_childrenCardPageViewIndicator",
"Learn to ",
"Code",
"Learn from ",
"AI",
